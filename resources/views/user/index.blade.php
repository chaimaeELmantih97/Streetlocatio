        ...
        <div class="col-md-4">
            <div class="portlet light profile-sidebar-portlet bordered">
                <div class="profile-userpic">
                    @if(Auth::user()->photo)
                    <img src="{{url('storage/users/'.Auth::user()->photo)}}" class="img-responsive"
                        alt="avatar">
                    @else 
                    {{-- <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar img-circle img-thumbnail"
                        alt="avatar"> --}}
                        <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="img-responsive" alt="">
                    @endif </div>
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab"
                                    data-toggle="tab">mettre à jour le profil</a></li>
                            <li role="presentation"><a href="#profile" aria-controls="profile" role="tab"
                                    data-toggle="tab">réservations effectuées</a></li>
                                ...
                                <form  method="POST"  action="{{route('user-profile-update',$profile->id)}}" enctype="multipart/form-data">
                                   @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputName"  name="name" placeholder="Nom" value="{{$profile->name}}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        name="current_password" id="password" placeholder="Ancien mot de passe">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn float-right" style="background: red; color:white">actualiser le profil</button>
                                </form>
                            </div>
