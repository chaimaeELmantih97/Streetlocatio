                        ...
                        <form method="POST" action="{{route('promos.store')}}">
                          @csrf 
                            <input type="hidden" value="{{$Car->id}}" name="id">
                              <button class="btn btn-success btn-sm" data-id={{$Car->id}} data-toggle="tooltip" data-placement="bottom" ><i class="fas fa-edit ml-2"></i> Ajouter ce produit a la liste des promos</button>
                            </form>
                    </td>
                </tr>  
            @endforeach
