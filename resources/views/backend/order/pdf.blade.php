...
<style type="text/css">
  ...
  <div class="invoice-header">
    <div class="float-left site-logo">
      <img src="{{asset('storage/alaor noir.png')}}" alt="">
    </div>
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>14 ben omar centre porte 4 maarif magasin Alaor num 17،, Casablanca 20100</p>
      <p>Phone: <a href="tel:+212615707007">+212615707007</a></p>
      <p>Email: <a href="mailto:contact@alaor.ma">contact@alaor.ma</a></p>
    </div>
  ...
  <div class="invoice-description">
    ...
    <div class="invoice-right-top float-right" class="text-right">
      ...
      {{-- <img class="img-responsive" src="data:image/png;base64, {{ base64_encode(QrCode::format('png')->size(150)->generate(route('admin.Car.order.show', $order->id )))}}"> --}}
    </div>
    <div class="clearfix"></div>
  </div>
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      <thead>
        <tr>
          <th scope="col" class="col-6">Car</th>
      ...
      @php 
        $Car=DB::table('cars')->select('title')->where('id',$cart->product_id)->get();
      @endphp
        <tr>
          <td><span>
              @foreach($Car as $pro)
