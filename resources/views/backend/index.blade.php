        ...
        <div class="card border-left-danger shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Vehicules</div>
                <div class="h5 mb-0 font-weight-bold text-dark-800">{{\App\Models\Car::countActiveProduct()}}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-sitemap fa-2x text-dark-300"></i>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Demandes</div>
                @php
                    $demandes=\App\Models\DemandeReservation::all();
                @endphp
                <div class="h5 mb-0 font-weight-bold text-dark-800">{{$demandes->count()}}</div>
              </div>
              <div class="col-auto">
                <i class="fas fa-cubes fa-2x text-dark-300"></i>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-danger shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Articles</div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                    @php
                    ...
                    @endphp
                    <div class="h5 mb-0 mr-3 font-weight-bold text-dark-800">{{$posts->count()}}</div>
                  </div>
