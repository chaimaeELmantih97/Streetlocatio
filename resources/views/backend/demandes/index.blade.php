            ...
            @foreach($demandes as $demande) 
                ...
                <tr>
                    ...
                    <td style="width:200px">
                     <a href="{{route('demandes.show',$demande->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
                    @if ($demande->status=='nouvel')
